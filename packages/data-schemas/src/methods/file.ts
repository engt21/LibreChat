...
export function createFileMethods(mongoose: typeof import('mongoose')) {
  ...
  /**
   * Retrieves user-uploaded files eligible for execute_code staging by their file IDs.
   * These are branch-scoped message/agent attachments; files generated by code execution are handled separately.
   * Existing fileIdentifier/nativeTool metadata is optional because ordinary attachments are uploaded lazily.
