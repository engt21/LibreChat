...
- Uses server preview responses as the source of truth for copied counts, warnings, source/destination lifecycle badges, create eligibility, and before/after preview content, including deduped rendering of server warnings alongside the generic partial-context warning.
